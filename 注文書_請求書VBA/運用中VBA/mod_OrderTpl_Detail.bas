...
' ���󖾍׃V�[�g�̖��ו��]�L�G���W���B
' �{�H�w����(�H��)/�{�H�ʒm��(�H��)�E�{�H�w����(�n��)/�{�H�ʒm��(�n��)�̎捞�ς݃V�[�g����
' �{�H���(�Ǝ҃}�X�^A�� �ƎҖ�)�Œ��o���A�_����於_�Ǘ����̃Z�N�V�����P�ʂœ]�L����B
' �H���敪���O���H���̏ꍇ: �H���V�[�g �� 2�s�� �� �n�ڃV�[�g(�O���茳��ЂŒ��o)�B
' �H���敪���n�ڍH���̏ꍇ: �n�ڃV�[�g(�n�ډ�ЂŒ��o)�̂݁B
' ���C����: CHANGELOG.md �Q��
...
Private Const SUMMARY_EXTRA_ROWS As Long = 5   ' �l��/�v/�����/���v/�r���p��
...
Private Const DETAIL_AMOUNT_NUMBER_FORMAT As String = "#,##0;-#,##0;"            ' ����؂�E�[����\��
Private Const DETAIL_QTY_DECIMAL_NUMBER_FORMAT As String = "#,##0.00;-#,##0.00;" ' ����2���E�[����\��
Private Const DETAIL_FONT_SIZE As Double = 11#
Private Const DETAIL_COL_A_WIDTH As Double = 7#
Private Const DETAIL_COL_QTY_4 As Long = 15          ' O��(��4���ʗ�)
Private Const DETAIL_COL_PRICE_4 As Long = 16        ' P��(��4�P����)
Private Const DETAIL_COL_PRICE_BASE As Long = 7        ' G��(�����P��)
...
Public Sub ApplyBreakdownDetails(ByVal wsBreakdown As Worksheet, _
    ...
    ' ���o: �O���H���͍H���V�[�g(A�� �{�H�Ǝ�)+�n�ڃV�[�g(B�� �O���茳���)�A
    '       �n�ڍH���͗n�ڃV�[�g(A�� �n�ډ��)�̂�
    ...
    ' ��4�O���[�v: O��=���ʁAP��=�P�����ʃZ���֓]�L����(2��ꊇ����P��֓���P����O��ւ����ꍇ������)
    ...
    ' 金額列(H/K/N/Q)の小数表示は、ApplyDetailFormats の整数書式の後に適用して優先させる
    ApplyDetailAmountColumnFormats wsBreakdown, startRow, subtotalRow - 1

    ' B:C��̌���(11�s�ځ`���v�s�̒��O�B�Z�N�V�������o���s��A:D�����̂��ߏ���)
    ...
    ' 11�s�ڈȍ~(�W�v�u���b�N�܂�)�̃t�H���g�T�C�Y��11�|�C���g�֓��ꂷ��
...
Private Sub BuildSummaryBlock(ByVal wsBreakdown As Worksheet, _
    ...
    ' H/K/N/Q ��: ���v=SUM(11:�ŏI�f�[�^�s)�A�l��=-MOD(���v,1000)�A�v=���v+�l���A
    ' �����=ROUNDDOWN(�v*�ŗ�,0)�A���v=�v+�����
...
' ���ו��{�W�v�u���b�N�̌r���𒍕����e���v���[�g�̗l���ɍ��킹�Ĉ��������B
' �Ώۂ͖��׊J�n�s�`���v�s(���v+4)�܂ŁEA:Q �S��B�s�̑}��/�폜�ŕ��ꂽ�r�������Z�b�g���čĕ`��B
'   ���r��: ���ׂ� xlHairline�B������ ���v�s�̏�=��d�� / ���v�s�̉�=xlMedium�B
'   �c�r��(����): �O�g��(A)�E�O�g�E(Q)�E���z�O���[�v���E(F/I/L/O �̍�)�B
'   �c�r��(�א�): ���̑��̗񋫊E(E/G/H/J/K/M/N/P/Q �̍�)�B
Private Sub ApplySummaryBorders(ByVal wsBreakdown As Worksheet, _
    ...
    ' �c�r��(�א�): ���̑��̗񋫊E(E/G/H/J/K/M/N/P/Q �̍�)
...
' �捞�ς݃V�[�g����{�H��ЂŒ��o���A�_����於_�Ǘ����̃Z�N�V�����ꗗ�����
' �߂�l: Collection of Array(�Z�N�V�������o��, �sCollection)�B�s = Array(�����ԍ�, �H�����, �����, �P��, ����, JR�P��)
...
Private Function CountBlockLines(ByVal sections As Collection) As Long
    ...
    For Each sectionItem In sections
        If total > 0 Then total = total + 1   ' �Z�N�V�����Ԃ̋󔒍s
        total = total + 1                     ' �Z�N�V�������o���s
        total = total + sectionItem(1).Count  ' �f�[�^�s
    Next sectionItem
...
Private Sub WriteBlockLines(ByVal sections As Collection, _
    ...
    Dim sectionItem As Variant
    For Each sectionItem In sections
        If Not isFirstSection Then lineCursor = lineCursor + 1   ' �Z�N�V�����Ԃ̋󔒍s
...
' ���ʂ̕\���`��: �n�ڂ͌��؂�Ȃ�(General)�A�H���͒P�ʂɉ����Đ���(0)/����2��(0.00)
...
Private Sub ApplyDetailFormats(ByVal wsBreakdown As Worksheet, _
    ...
    ' ���ʗ�(F/I/L/O): �P�ʂ�����2���Ώ�(m/m3/M/�u/t)�̍s������2���\���֏㏑��
...
' �捞���V�[�g��1�s�ڂ���u��Ж�+�P���v�w�b�_�[��𖼊񂹂ŒT��
...
' ���󖾍׃V�[�g�̑O��(I��)/����(L��)/��4����(O��)�ւ̐��ʓ��͂��Ď����A�P����(J/M/P)���������͂���B
' I12/L12 �̓��͗L���ɉ����ďW�v�u���b�N�� K/N ��[���\�����X�V����B
' ThisWorkbook.Workbook_SheetChange ����Ă΂��
...
' �W�v�u���b�N(���v�`���v)�̋��z�\���`���BK/N��� I12/L12 �̓��͗L���Ń[���\����ؑ�
...
' �A�N�e�B�u�ȓ��󖾍׃V�[�g�ցA�r���EA�񕝁E�W�v���l�������蓮�ōēK�p����(����/�ꊇ�C���p)�B
' �����ς݂̓��󖾍׃V�[�g��\��������Ԃ� Alt+F8 ������s����B
...
' "���v�s��������܂���B���󖾍׃V�[�g���A�N�e�B�u�ɂ��Ď��s���Ă��������B"
