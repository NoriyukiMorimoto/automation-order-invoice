...
Private Sub DrawBasicInfoCalendar(ByVal ws As Worksheet, ByVal targetCell As Range, ByVal displayMonth As Date, ByVal baseDate As Date)
    ...
    AddCalendarShape ws, "Close", msoShapeRectangle, leftPos + calendarW - 36, topPos + footerTop, 28, 22, "Å~", RGB(241, 245, 249), RGB(148, 163, 184), 1, "'" & ThisWorkbook.Name & "'!BasicInfoCalendarClose"
    AddCalendarShape ws, "Title", msoShapeRectangle, leftPos + 42, topPos + 8, calendarW - 84, 24, Format$(displayMonth, "yyyyîNmåé"), RGB(248, 250, 252), RGB(248, 250, 252), 0

    Dim weekNames As Variant
    weekNames = Array("ì˙", "åé", "âŒ", "êÖ", "ñÿ", "ã‡", "ìy")
